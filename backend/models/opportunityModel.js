...
const FALLBACK_OPPORTUNITIES = [
  ...
  {
    id: 'opp-03',
    title: 'Quezon City Youth Leadership & Academic Grant',
    provider_name: 'Quezon City Youth Development Office',
    provider_logo: null,
    provider_type: 'Government',
    category: 'Grant',
    funding_type: 'Merit-Based',
    eligibility_badge: 'Active QC Student Leader, Good Standing',
    deadline: '2026-09-10',
    external_url: null,
    description: 'Special academic stipend recognizing outstanding student leaders and youth community service scholars in Quezon City.',
    amount: 20000,
    location: 'Quezon City',
    status: 'open',
  },
