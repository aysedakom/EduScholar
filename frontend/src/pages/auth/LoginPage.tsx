              ...
              <form onSubmit={handleCredentialsSubmit} className="space-y-4" autoComplete="off">
                ...
                <div className="pt-3 border-t border-slate-100 space-y-2">
                  <span className="text-[10px] font-extrabold uppercase tracking-wider text-slate-400 block text-center">
                    Quick Role Selector (Default: January10)
                  </span>
                  <div className="grid grid-cols-2 gap-1.5 text-xs">
                    <button
                      type="button"
                      onClick={() => {
                        setEmail('support.edu2026@gmail.com');
                    ...
                    >
                      <span className="font-bold text-slate-800 block text-[11px]">🏛️ Admin</span>
                      <span className="text-[9px] text-slate-400 font-mono">support.edu2026</span>
                    </button>

                    <button
                      type="button"
                      onClick={() => {
                        setEmail('treasury.edu2026@gmail.com');
                        setPassword('January10');
                        setSelectedRole('treasury');
                      }}
                      className="p-2 rounded-xl bg-slate-50 hover:bg-blue-50 border border-slate-200/70 text-left transition-all"
                    >
                      <span className="font-bold text-slate-800 block text-[11px]">💰 Treasury</span>
                      <span className="text-[9px] text-slate-400 font-mono">treasury.edu2026</span>
                    </button>

                    <button
                      type="button"
                      onClick={() => {
                        setEmail('sr.edu2026@gmail.com');
                        setPassword('January10');
                        setSelectedRole('school_coordinator');
                      }}
                      className="p-2 rounded-xl bg-slate-50 hover:bg-blue-50 border border-slate-200/70 text-left transition-all"
                    >
                      <span className="font-bold text-slate-800 block text-[11px]">🏫 Coordinator</span>
                      <span className="text-[9px] text-slate-400 font-mono">sr.edu2026</span>
                    </button>

                    <button
                      type="button"
                      onClick={() => {
                        setEmail('sv.edu2026@gmail.com');
                        setPassword('January10');
                        setSelectedRole('supervisor');
                      }}
                      className="p-2 rounded-xl bg-slate-50 hover:bg-blue-50 border border-slate-200/70 text-left transition-all"
