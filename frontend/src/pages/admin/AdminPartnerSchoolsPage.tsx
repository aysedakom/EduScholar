...
export const DEFAULT_PARTNER_SCHOOLS: AdminPartnerSchool[] = [
  {
    ...
    contactPerson: 'Engr. Charlie I. Cariño (Registrar / Coordinator)',
    contactNumber: '(02) 8417-4355',
    email: 'bcp.edu67@gmail.com',
  ...
  },
  {
    ...
    contactPerson: 'Dr. Aris Ramos (University Registrar / Coordinator)',
    contactNumber: '(02) 8806-3000',
    email: 'qcu.edu67@gmail.com',
    partnershipStatus: 'Active',
    partnershipStart: '2024-01-01',
    partnershipEnd: '2028-12-31',
  ...
  },
  {
    ...
    schoolType: 'Private',
    address: 'Caloocan / QC Border Campus',
    contactPerson: 'Prof. Maria Santos (Campus Coordinator)',
    contactNumber: '(02) 8951-4022',
    email: 'stclaire.edu67@gmail.com',
    partnershipStatus: 'Active',
    partnershipStart: '2024-01-01',
    partnershipEnd: '2028-12-31',
    programsOffered: 'BSIT, BSBA, BSA, BSED, BEED',
    ...
    <div className="space-y-5 animate-in fade-in duration-300">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 bg-white dark:bg-slate-900 p-5 sm:p-6 rounded-3xl border border-slate-200 dark:border-slate-800 shadow-soft">
        <div className="space-y-1">
          {/* Back button when inspecting specific school student list */}
          {viewMode === 'students' && !isCoordinator && (
            <div className="flex items-center gap-2 mb-1">
              ...
              >
                <ArrowLeft className="h-3.5 w-3.5" /> Back to Partner School Directory
              </button>
            </div>
          )}
          {viewMode === 'students' ? (
