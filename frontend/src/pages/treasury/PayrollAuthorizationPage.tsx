                        ...
                        <div className="flex items-center justify-end gap-1.5">
                          {statusStr !== 'Approved for Payout' && statusStr !== 'Disbursed' && (
                            <button
                              ...
                              className="px-2.5 py-1.5 rounded-lg bg-emerald-50 dark:bg-emerald-950/60 text-emerald-700 dark:text-emerald-300 border border-emerald-200 dark:border-emerald-800 hover:bg-emerald-100 font-bold text-[11px] flex items-center gap-1 transition-colors"
                            >
                          ...
                          {statusStr !== 'On-Hold' && statusStr !== 'Disbursed' && (
                            <button
                              ...
                              className="px-2.5 py-1.5 rounded-lg bg-amber-50 dark:bg-amber-950/60 text-amber-700 dark:text-amber-300 border border-amber-200 dark:border-amber-800 hover:bg-amber-100 font-bold text-[11px] flex items-center gap-1 transition-colors"
                            >
